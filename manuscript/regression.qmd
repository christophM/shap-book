...
In this chapter, we will revisit the wine data and fit a tree-based model, an xgboost model.
...
grid_search = GridSearchCV(estimator=model, param_grid=param_dist, cv=3, scoring='neg_mean_squared_error', verbose=0)
