...
For instance, when calculating the Shapley value of the 6th word in a text, only neighboring words are considered for word absence, based on the assumption that distant words have minimal interaction.
