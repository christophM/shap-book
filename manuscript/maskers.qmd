...
To apply Shapley values from game theory to machine learning interpretability, we need to frame the prediction as a game, with feature values of a data point being the players.
...
Here is an illustration of how that Independent masker operates.
...
Next we create a masker an apply it to data point (f1=0, f2=0, f3=0).
