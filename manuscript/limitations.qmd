...
- Recognize limitations of SHAP values
- Stay strong against in the face of hype
...
We've already discussed issues such as the [correlation problem](#correlation) and the complexity of [interpreting interactions](#interaction).
...
But they do tell you which features need to be preserved to avoid a regression to the mean.
