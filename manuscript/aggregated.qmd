...
This chapter gives an overview of the plots that are available for aggregated Shapley values.
Aggregated means computing Shapley values for all features and all data points of some dataset.
Therefore you'll only find plots for tabular data, because for text and image there is no meaningful aggregation across images/texts.
