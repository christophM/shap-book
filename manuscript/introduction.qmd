...
To give you a first idea what this looks like, @fig-waterfall gives you a first impression.
If you use SHAP to explain a prediction, you get one value per input feature that tells you how much this feature value contributed towards the prediction.
...
#| echo: false
#| label: fig-waterfall
#| caption: SHAP values to explain a prediction. 
import shap
...
Don't worry, you don't have to fully understand this figure just yet.
It's just the target to keep in mind.
That's where we are going with this book, starting with the necessary background in Shapley values, seing how this transfers to explaining machine learning predictions and then actually applying those techniques.
...
TODO: Rewrite this section. move ad to the end of the book
...
SHAP values are used in various areas to explain predictive models:
...
For now, it's the goals 


TODO: Write a small guide here for the book structure
