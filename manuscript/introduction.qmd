...
<!-- Motivation for XAI -->
Machine learning models are powerful tools, but their lack of interpretability
is a challenge.
It's often unclear why a certain prediction was made, what the most important features were, and how the features influenced the predictions in general.
<!-- is it important? -->
...
And under this keyword you find a colorful variety of approaches that attempt
...
The understanding of this figure isn't crucial at this point; it's simply the goal to keep in mind as we dive into the theory behind SHAP in the following chapters.
...
Before we talk about practical application of SHAP, let's begin with its historical background, which provides context for the subsequent theory chapters.
