...
![In reality, asthma increases the likelihood of pneumonia. However, in the study, asthma also increased the (preemptive) use of antibiotics which protects against pneumonia.](images/asthma-dag.jpg){#fig-asthma out.width="50%"}
...
Let's talk now about how this concept from game theory (Shapley values) is useful to explain predictions.
