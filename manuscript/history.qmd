...
- The historic milestones of SHAP values
- Understand how SHAP and Shapley values are kind of the same thing
- Get a bird's eye view on the development which also serves as a frame for learning the theory
...
If you don't care about the history but only about the application of SHAP, there is no harm in skipping this history chapter.
...
Keeping this historic outline in mind, we start from the beginning with game theory in the next chapter.
