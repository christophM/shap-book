...
Below are examples of how these different options look, primarily featuring melting burgers.
```{python}
...
Unlike replacing all missing values with gray pixels, maskers don't entirely alter the image.
...
The mistaken classification identified the cheeseburger as a bottle cap.
...
In all instances, the pixels at the bottom of the burger seemed to counter the bottle cap classification.
