...
Now, let's delve into image data.
...
One of these is a cheeseburger, which we'll encounter later.
...
Let's delve into the different maskers, as they're more than just a "set-and-forget" parameter.
...
- We acquire more detailed superpixels, which are associated with the Partition explainer. With only 10 evaluations, we see 4 leaves, requiring a tree depth of 2, which leads to 2 + 2 * 2 = 6 SHAP values.
