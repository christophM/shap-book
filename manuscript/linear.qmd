...
Simple because it is already interpretable, allowing us to compare SHAP values with our intuitive understanding of the model: a linear regression model.
...
The SHAP value in the linear case is:
