...
Since the model is a linear regression model, we know that this modeled relationship must be linear.
However, that's just for the model, the "true" relationship in the data might be non-linear.
