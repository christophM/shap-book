...
"But that's why I loved it" has a huge positive contribution to the sentiment, more than the two negative sentence combined.
...
What changes is the base value, it shifts from strongly positive to negative, as can be inferred from the difference in the base value.
