...
## Shapley values recover non-linear functions
...
In the next chapter, we will allow the model to have interactions and see how this affects the interpretation of the Shapley values.
