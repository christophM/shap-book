...
All the red pixels contributed positively to the respective class and blues one negatively.
...
Make sense, since in both cases the result should be the same Shapley values and difference only due to the fact that both are approximated.
