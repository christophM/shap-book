...
- Understand differences between SHAP based on pixels versus larger patches
...
The second, third, and fourth dimensions contain the SHAP values in the form of an image since the input data was an image.
...
Grey pixels have a near zero SHAP value.
For example, for the digit "2" in the second, the class output "1" has blue pixels at the left and right beginning/ending of the "2" image.
