...
Other packages might also create their own implementations of SHAP.
...
Ultimately, it's up to you to decide whether to use the original `shap` package, opt for another package implementing SHAP, or even create your own implementation.

A significant advantage of SHAP values is their clear definition, enabling consistent explanations even when switching implementations.
