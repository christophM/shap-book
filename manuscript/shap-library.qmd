...
I believe the `shap` library is the most widely-used implementation of Shapley values.
...
## The Open-Source Model is Challenging
...
In Python, relying on `shap` internally:
