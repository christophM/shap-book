...
- The further away from the stage ($x_2$), the smaller the Shapley values.
- The taller the fan ($x_1$), the smaller the Shapley values.

But there are also some breaks in the patterns: There are small fans that receive a large Shapley value. This is due to the interaction (sitting on shoulders).
