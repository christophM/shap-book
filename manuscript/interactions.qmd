...
- The -8 is just so that the output is roughly between 0 (bad concert experience) and 10 (greatly enjoying the concert)
...
Neither of them profits from the shoulder bonus, so Mia being smaller than Tom should mean that her SHAP value for "height" should be smaller than Tom's, right?
